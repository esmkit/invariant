...
describe("invariant", () => {
  it("should not throw an error when the condition is true", () => {
    ...
    expect(() => invariant(value1 !== null && value1 !== undefined, "Value should not be null or undefined")).not.toThrow();

    const value2 = null;
    expect(() => invariant(value2 !== null && value2 !== undefined, "Value should not be null or undefined")).toThrow("Value should not be null or undefined");
  ...
  it("should throw an error when the condition is false", () => {
    ...
    expect(() => invariant(value1 !== null && value1 !== undefined, "Value should not be null or undefined")).toThrow("Value should not be null or undefined");
